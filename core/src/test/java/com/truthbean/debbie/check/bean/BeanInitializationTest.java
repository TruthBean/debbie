...
import com.truthbean.debbie.check.asm.AsmClassCreator;
...
public class BeanInitializationTest {
    ...
    void init() {
        ...
        for (int i = 0; i < 100_000; i++) {
            ...
            Class<?> cls = classCreator.createClass(className, "com.truthbean.debbie.check.bean",
                    AsmClassCreator.class.getClassLoader(), "com.truthbean.debbie.check.bean.TestSimpleBean", false);
            ...
            initialization.registerBeanInfo(beanInfo);
        }
    ...
    void createClass() {
        ...
        Class<?> cls = classCreator.createClass(className, "com.truthbean.debbie.check.bean",
                BeanInitializationTest.class.getClassLoader(), "com.truthbean.debbie.check.bean.TestSimpleBean", false);
