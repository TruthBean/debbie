...
class AnnotationParserTest {
    ...
    void parse() {
        ...
        Console.println(annotationInfo);
        Console.println(annotationInfo.getOrigin());
        Console.println("");
        annotationInfo.properties().forEach((name, info) -> {
            Console.println(name);
            Console.println(info.getValue());
        ...
        map.forEach((type, info) -> {
            ...
            Console.println(info.getOrigin());
            info.properties().forEach((name, property) -> {
                Console.println("");
                Console.println(name);
                Console.println(property.getValue());
            });
        });
