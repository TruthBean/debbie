...
public class BeanFactoryContext {
    ...
    // private final BeanCreatedFactory beanCreatedFactory;

    private static final Object object = new Object();

    @SuppressWarnings("unchecked")
    protected BeanFactoryContext(ClassLoader classLoader) {
        synchronized (object) {
            ...
            // this.beanCreatedFactory = new BeanCreatedFactory(this);
        }
    }
    ...
    protected <T> T factory(String serviceName, Class<T> type, boolean require, boolean throwException) {
        ...
        // return this.beanCreatedFactory.factory(beanInfo);
    ...
    public static final Logger LOGGER = LoggerFactory.getLogger(BeanFactoryContext.class);
}
