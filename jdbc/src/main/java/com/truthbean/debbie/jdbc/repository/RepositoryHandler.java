...
public class RepositoryHandler {
    ...
    public static final RepositoryHandler INSTANCE = new RepositoryHandler();
    ...
    public final void call(Logger logger, final TransactionInfo transaction, final String sql,
                           Consumer<CallableStatement> callableStatementConsumer) {
        loggerSqlAndParameters(logger, sql, null);
    ...
    public final <K> K insert(Logger logger, final TransactionInfo transaction, final String sql, final boolean generatedKeys,
        ...
        try {
            ...
            transaction.setUsing(true);
            var connection = transaction.getConnection();
            if (keyClass != null && transaction.isClosed()) {
                return (K) ReflectionUtils.getDefaultValue(keyClass);
            }
